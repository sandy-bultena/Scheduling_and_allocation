from .InitGuiFontsAndColours import set_default_fonts_and_colours, TkColours, TkFonts
from .InitGuiFontsAndColours import colours as tk_colours
from .InitGuiFontsAndColours import fonts as tk_fonts
