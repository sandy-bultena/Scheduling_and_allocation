...
# from ..gui_pages.view_choices_tk import ViewChoicesTk
...
#         """Creates a ViewsHubControl object.
#
#         Parameters:
...
#         gui = ViewChoicesTk(gui_main)
#         self.gui = gui
#         self.gui_main = gui_main
#         ViewsHubControl.max_id += 1
#         self._id = ViewsHubControl.max_id
...
#     @property
#     def id(self):
#         """Returns the unique ID for this ViewsHubControl object."""
#         return self._id
#
#     def set_dirty(self):
...
#     # =================================================================
#     def undoes(self):
#         """Gets the Undo objects of this ViewsHubControl object."""
#         return self._undoes
#
#     def redoes(self):
#         """Gets the Redoes of this ViewsHubControl object."""
#         return self._redoes
#
#     def undo(self, resource_type: str):
#         """Undo or Redo the last action.
#
#         Parameters:
#             resource_type: 'undo' or 'redo'.
#             """
...
#         """Add an Undo to the list of Undoes for this ViewsHubControl object.
#
#         Returns the modified ViewsHubControl object."""
#         self._undoes.append(undo)
#         return self
#
#     def add_redo(self, redo: Undo):
#         """Adds a Redo to the list of Redoes for this ViewsHubControl object.
#
#         Returns the modified ViewsHubControl object."""
...
#         """Removes all Undoes associated with this ViewsHubControl object.
#
#         Returns the modified ViewsHubControl object."""
#         self._undoes.clear()
#         return self
...
#         """Removes all Redoes associated with this ViewsHubControl object.
#
#         Returns the modified ViewsHubControl object."""
#         self._redoes.clear()
#         return self
...
#         """Makes sure that the views have access to the ViewsHubControl."""
...
#
#     def is_open(self, id: int, resource_type):
...
#             resource_type: The resource_type of view that you want to check.
#
#         Returns:
#             The View object if the View is open, False otherwise."""
#         open_views: dict = self.views()
#         for view in open_views.values():
#             if view.resource_type == resource_type:
...
#
#     def views(self):
#         """Get the Views of this ViewsHubControl object."""
#         return self._views
#
#     def add_view(self, view: View):
#         """Add a View to the list of Views for this ViewsHubControl object.
#
#         Parameters:
...
#
#         for view in open_views.values():
#             view.update_for_conflicts(view.resource_type)
#
...
#
#         for resource_type in all_view_choices.valid_types():
#             scheduable_objs = all_view_choices.by_type(resource_type).scheduable_objs
#
#             # Calculate conflicts.
...
#     # =================================================================
#     def create_view_containing_block(self, schedulable_objs, resource_type: ResourceType | str, ob: Block = None):
...
#             resource_type: Type of view to draw (teacher/lab/stream).
#             ob: Block object."""
...
#
#         if resource_type == 'teacher' or resource_type == ResourceType.Teacher:
...
#                 self.create_new_view(None, scheduable_obj, resource_type)
#
#     def create_new_view(self, undef, scheduable_obj, resource_type):
...
#             resource_type: Type of view to show (teacher/lab/stream)."""
#         open_view: View | False = self.is_open(scheduable_obj.number, resource_type)
#
#         if not open_view:
