...
class GenericCanvas(Protocol):
    def create_line(self, x1:float, y1:float, x2:float, y2:float, fill:str="grey", dash="", tags=()): ...
    def create_text(self, x:float, y:float, text:str="", fill:str='black', tags:tuple[str,...]=())->int:...
