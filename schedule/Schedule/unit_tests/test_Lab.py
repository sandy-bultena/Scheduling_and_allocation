...
class TestLab:
    ...
    def test_id_multiple_labs(self):
    ...
    def test_remove_unavailable_good(self):
    ...
    def test_remove_unavailable_no_crash(self):
    ...
    def test_get_unavailable_good(self):
    ...
    def test_get_unavailable_bad_input(self):
    ...
    def test_unavailable_no_slots(self):
    ...
    def test_share_blocks_true(self):
    ...
    def test_share_blocks_false(self):
    ...
    def test_remove_gets_slots(self):
