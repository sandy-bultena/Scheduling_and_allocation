...
class TestTeacher:
    ...
    def test_firstname_setter_good(self):
    ...
    def test_firstname_setter_bad(self):
    ...
    def test_lastname_setter_bad(self):
    ...
    def test_get_by_name_good(self):
