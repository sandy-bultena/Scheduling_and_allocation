...
class NumStudents:
    ...
    def __init__(self, frame, schedules: list[Model.Schedule]):
        """
    ...
    # update the data
    # =======================================================================================================
    def _refresh(self, schedules: list[Model.Schedule]):
        """
    ...
    # gather data
    # =======================================================================================================
    def _gather_data(self, schedules: list[Model.Schedule]):
        """
        ...
        for semester_name in ("fall", "winter", "summer"):
            ...
            schedule: Model.Schedule = schedules[semester_name]
