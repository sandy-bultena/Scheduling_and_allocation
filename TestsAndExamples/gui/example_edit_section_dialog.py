...
from schedule.gui_dialogs.edit_section_dialog_tk import AddEditSectionDialogTk
...
def apply_changes(teachers, labs, streams, blocks):
    print( teachers, labs, streams, blocks)
...
def go_edit():
    ...
    for b in s_001_1.blocks():
        block_data.append( (b.time_slot.day.name, str(b.time_slot.time_start), str(b.time_slot.time_end)))
    db = AddEditSectionDialogTk(frame, "edit",
