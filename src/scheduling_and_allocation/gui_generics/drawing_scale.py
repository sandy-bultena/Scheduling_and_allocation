...
DEFAULT_START: float = 8.0
DEFAULT_END: float = 18.0

# =============================================================================================================
# Get a drawing scale (for schedule views) based off a factor
# =============================================================================================================
class DrawingScale:
    def __init__(self, factor=CURRENT_SCALE, end_of_day=DEFAULT_END):
        ...
        self.y_height_scale: float = DEFAULT_Y_HEIGHT_SCALE * factor * \
                                     (DEFAULT_END-DEFAULT_START)/(end_of_day-DEFAULT_START)
